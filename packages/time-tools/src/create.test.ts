...
describe("create", () => {
  ...
  testCases.forEach((testCase) => {
    it(testCase.description, () => {
      expect(create(testCase.input.hours, testCase.input.minutes, testCase.input.seconds)).toEqual(testCase.expected);
    });
  });
  ...
  invalidTestCases.forEach((testCase) => {
    it(testCase.description, () => {
      expect(() => create(testCase.input.hours, testCase.input.minutes, testCase.input.seconds)).toThrow();
    });
  });
});
